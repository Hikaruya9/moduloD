...
<section class="flex justify-center items-center min-h-screen bg-gray-900">
    <div class="bg-gray-800 text-white p-8 rounded-lg shadow-lg w-full max-w-lg">
        ...
        <form action="actions.php" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                <label for="new-book-title" class="block text-sm font-medium text-gray-300">Título</label>
            ...
            <!-- Novo autor do livro -->
            <div>
                <label for="new-book-author" class="block text-sm font-medium text-gray-300">Autor</label>
            ...
            <div>
                <label for="new-book-desc" class="block text-sm font-medium text-gray-300">Descrição</label>
            ...
            <!-- Nova capa do livro -->
            <div>
                <label for="new-book-cover" class="block text-sm font-medium text-gray-300">Capa</label>
                <div class="relative">
                    <input type="file" name="new-book-cover" class="absolute inset-0 w-full opacity-0 cursor-pointer"/>
